...
class Ui_druzynyForm(object):
    def setupUi(self, druzynyForm):
        ...
        self.gridLayout.addWidget(self.pushButton_usun, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_dodaj, 2, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButton_losuj_drzewko, 4, 1, 1, 2)
